<?php 
        ...
        session_start();
          if(empty($_SESSION['username']) || !(isset($_SESSION['username']))){
              ...
              $req = $db->query("SELECT * FROM Articles WHERE Categories = '$_GET[categories]'");
          }
...
<head>
    ...
    <title>Liste Des Articles Par Catégories</title>
    ...
    <link rel="stylesheet" href="mesarticles.css" type="text/css" />
</head>
<body>
    <header>
